...
//                 <img
//                   src="https://img.freepik.com/premium-photo/full-shopping-cart-black-friday-ar-74_950002-287993.jpg?w=1060"
//                   alt="benefits"
//                   width={320}
//                   height={320}
        ...
        <div className="flex flex-wrap items-center justify-between lg:flex-nowrap">
          ...
          <div className="relative z-[1] mb-10 lg:w-1/2">
            ...
            >
              ...
              <div className="mt-12 md:flex md:space-x-8 lg:justify-end">
                <img
                  src="https://img.freepik.com/premium-photo/shopping-basket-full-variety-grocery-products_926154-1020.jpg?w=740" // Replace with an appropriate image URL
                  alt="FAQ and Support"
                  width={450}
                  height={250}
