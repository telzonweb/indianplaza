      ...
      <div className="relative mx-[5%] flex flex-col gap-1 rounded-xl shadow-sm md:flex-row lg:mx-[7%] lg:p-6">
        <div className="relative self-center rounded-2xl bg-[#ffd9a1] p-5 shadow-lg md:w-1/2 lg:mr-[-40px]  lg:px-10 lg:py-8">
          ...
          <p className=" mb-6 font-satisfy text-lg text-[#000]">
            From India's vibrant fields, cumin seeds capture our rich heritage.
            Infusing flavor into every dish, these tiny seeds carry centuries of
            tradition, connecting past and present. Each seed tells a story of
            ancient culinary art and medicinal wisdom, integral to our culture.
            Celebrate the spice that embodies the warmth, depth, and richness of
            Indian heritage, uniting generations through its unmistakable aroma
            and taste.
          </p>
